	...
	<main class="wrapper sb-default">
                            ...
                            <ul class="cr-sb-drop condense">
                                ...
                                <li class="cr-sb-item sb-subdrop-item">
                                    ...
                                    <ul class="cr-sb-subdrop condense">
                                        <li><a href="vendor-profile.php" class="cr-page-link subdrop"><i class="ri-checkbox-blank-circle-line"></i>پروفایل</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
		...
		<div class="cr-notify-bar">
			<div class="cr-bar-title">
				<h6>اطلاعیه<spanClass="label">12</span></h6>
										...
										<div class="cr-vendor-block-img">
											<div class="cr-vendor-block-detail">
												<div class="profile-img">
													<img class="v-img" src="assets/img/user/cat_1.jpg"
														alt="vendor image">
													<span class="tag-label online"></span>
												</div>
												<h5 class="name"><?=$_SESSION['adminInfo']['firstname']. $_SESSION['adminInfo']['lastname'] ?></h5>
												<p>(<?=$_SESSION['adminInfo']['email']?>)</p>
												<div class="cr-settings">
													...
													<div class="dropdown">
														...
														<ul class="dropdown-menu">
															<li><a class="dropdown-item" href="#"><span class="tag-label online"></span>آنلاین</a></li>
															<li><a class="dropdown-item" href="#"><span class="tag-label offline"></span>آفلاین</a>
															</li>
															<li><a class="dropdown-item" href="#"><span class="tag-label busy"></span>مشغول</a></li>
														</ul>
													</div>
												</div>
											</div>
											<div class="cr-vendor-info">
												<ul>
													<li><span class="label">نام:</span><?=$_SESSION['adminInfo']['firstname']." ".$_SESSION['adminInfo']['lastname']?></li>
...
و تاریخ سفارشات.</p>
									...
									<div class="col-md-6 col-sm-12">
										<div class="cr-vendor-detail">
											<h6>آدرس ایمیل</h6>
											<ul>
												<li><strong>ایمیل:</strong><?=$_SESSION['adminInfo']['email']?></li>
											</ul>
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
										<div class="cr-vendor-detail">
											<h6>شماره تماس</h6>
											<ul>
												<li><strong>شماره تلفن:</strong><?=$_SESSION['adminInfo']['mobile']?></li>
											</ul>
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
										<div class="cr-vendor-detail">
											<h6>نشانی</h6>
											<ul>
												<li><?=$_SESSION['adminInfo']['address']?></li>
											</ul>
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
										<div class="cr-vendor-detail">
											...
											<ul>
												<li><strong>نام کاربری :</strong><?=$_SESSION['adminInfo']['firstname']?></li>
                                                <?php
                                                $bank=explode('-',$_SESSION['adminInfo']['bank_account']);
                                                ?>
												<li><strong>شماره حساب :</strong><?=$bank[1]?></li>
												<li><strong>نام بانک :</strong><?=$bank[0]?></li>
											</ul>
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
										<div class="cr-vendor-detail">
                                            <?php
                                            $social_media=explode('-',$_SESSION['adminInfo']['social_media']);
                                            ?>
											<h6>رسانه های اجتماعی</h6>
											<ul>
												<li><strong><i class = "ri-instagram-fill"> </i></strong><a
														href="#"><?=$social_media[0]?></a></li>
												<li><strong><i class = "ri-telegram-fill"> </i></strong><a
														href="#"><?=$social_media[1]?></a></li>
											</ul>
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
