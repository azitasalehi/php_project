(function ($) {
        ...
        let eventCalendar = $("#eventCalendar").simpleCalendar({
            ...
            events: [
                // generate new event after tomorrow for one hour
                {
                    ...
                    summary: "به دفتر مرکزی  مراجعه کنید"
                },
                ...
                },
                {
                    ...
                    endDate: new Date(new Date().setHours(new Date().getHours() - 24)).getTime(),
                    summary: "به لورنس مادون قرمز مراجعه کنید."
                }
            ],
    ...
    /*========== Recent order DATA TABLE(add-category.php.html) ===========*/
    ...
    $('.pop-basic').on("click", function () {
        Swal.fire('هر کسی می تواند از رایانه استفاده کند')
    });
    ...
    $('.pop-like').on("click", function () {
        Swal.fire({
            ...
            icon: 'info',
            html:
                'شما می توانید استفاده کنید <b>تکست بولد</b>, ' +
                '<a href="//sweetalert2.github.io">لینک</a> ' +
                'یا تگ های اچ تی ام ال دیگر',
            showCloseButton: true,
            showCancelButton: true,
            focusConfirm: false,
            confirmButtonText:
                '<i class="ri-thumb-up-line"></i> عالی!',
            confirmButtonAriaLabel: 'شست, عالی!',
            cancelButtonText:
                '<i class="ri-thumb-down-line"></i>',
            cancelButtonAriaLabel: 'شست پایین'
        })
    });
