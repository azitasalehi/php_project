                    ...
                    <ul class="cr-sb-list">
                        <li class="cr-sb-item sb-drop-item">
                            ...
                            <ul class="cr-sb-drop condense">
                                <li><a href="index.php" class="cr-page-link drop"><i class="ri-checkbox-blank-circle-line"></i>ایکامرس</a></li>
                                <li><a href="product-list.php" class="cr-page-link drop"><i class="ri-checkbox-blank-circle-line"></i>لیست محصول</a></li>
                                <li><a href="add-product.php" class="cr-page-link drop"><i class="ri-checkbox-blank-circle-line"></i>افزودن محصول</a></li>
										...
										<div class="cr-cat-form">
											...
											<form action="" method="post">
												...
												<div class="form-group row">
													<label>توضیح</label>
													<div class="col-12">
														<textarea id="sortdescription" name="content" cols="40"
															rows="2" class="form-control"></textarea>
													</div>
												</div>
												<div class="row">
													<div class="col-12 d-flex">
														<button name="btn_submit" type="submit" class="cr-btn-primary">ثبت</button>
													</div>
												</div>
...
include "../include/includes.php";
        if (isset($_POST['btn_submit'])){
            ...
            $(function (){Swal.fire({position: 'top-center',icon: 'warning',title: 'یک فیلد خالی است',showConfirmButton: false,timer: 1500});});        </script>";
                ...
                Top_category::addCategory($categoryArray);
            }
        }
?>
										</div>
							...
							<div class="cr-card-content ">
								<div class="table-responsive tbl-800">
									<table id="cat_data_table" class="table">
										...
										<tbody>
                                        <?php $categories=Top_category::getTopCategoryByParent_Id(4);
                                        foreach($categories as $category):?>
											<tr>
												<td>
													<span class="cr-sub-cat-list">
														<span class="cr-sub-cat-tag"><?=$category->category_name?></span>
													</span>
												</td>
												<td><?=rand(11,80)?></td>
												<td class="active">فعال</td>
												<td>
													<div>
														<button type="button"
