                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="shop-full-width.php">
                                        عرض کامل
                                    </a>
                                        </li>
                                    </ul>
                ...
                <ul>
                    ...
                    <li class="dropdown drop-list">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="shop-full-width.php">تمام عرض</a></li>
                        </ul>
                    </li>
                    <li class="dropdown drop-list">
                        <span class="menu-toggle"></span>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="cr-breadcrumb-title">
                            <h2>سبد خرید</h2>
                            <span> <a href="index.php">خانه</a> / سبد خرید</span>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <form action="#">
                                <div class="cr-table-content">
                                    <table id="shoppingTable">
                                        ...
                                        <tfoot>
                                        <tr>
                                            <td style="background-color: #e9e9e9" colspan="6" class="text-center text-dark total-amount "><span>جمع کل :</span> <strong></strong><small> تومان</small></td>
                                        </tr>
                                        </tfoot>
                                    </table>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="cr-cart-update-bottom">
                                            <a href="javascript:void(0)" class="cr-links"> ادامه خرید </a>
                                            <a href="cart.php" class="cr-button">
                                                ادامه خرید
                                            </a>
                                        </div>
                                    </div>
