(function ($) {
    ...
    $('.wishlist').on("click", function () {
        ...
        if (isWishlist) {
            ...
            $('footer').after('<div class="cr-wish-notify"><p class="wish-note"> حذف محصول از  <a href="wishlist.html"> لیست علاقه مندی </a> موفقیت آمیز بود!</p></div>');
        } else {
            $(this).addClass("active");
            $('footer').after('<div class="cr-wish-notify"><p class="wish-note">اضافه کردن محصول به<a href="wishlist.html"> لیست علاقه مندی </a> موفقیت آمیز بود!</p></div>');
        }
    ...
    $('.cr-shopping-bag').on("click", function () {
        ...
        if (isAddtocart) {
            $(this).removeClass("active");
            $('footer').after('<div class="cr-cart-notify"><p class="compare-note"> حذف محصول از  <a href="cart.php"> سبد خرید </a> موفقیت آمیز بود!</p></div>');
        } else {
            $(this).addClass("active");
            $('footer').after('<div class="cr-cart-notify"><p class="compare-note">اضافه کردن محصول به<a href="cart.php"> سبد خرید </a> موفقیت آمیز بود!</p></div>');
        }
        setTimeout(function () {
